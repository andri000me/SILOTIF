        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="event-detail-content">
                    ...
                    <div class="button-df mt-2">
                        <!-- <a href="<?php echo base_url(); ?>event/view/<?php echo $row->event_id; ?>">Daftar Sekarang <i class="fa fa-chevron-circle-right"></i></a> -->
                        <a href="#">Daftar Sekarang <i class="fa fa-chevron-circle-right"></i></a>
                    </div>
                            ...
                            <?php if ($today < $row['event_start_date']) : ?>
                                <div class="sidebar-recent-item">
                                    ...
                                    <div class="recent-text">
                                        ...
                                        <div class="rpwwt-post-date">Awal Pendaftaran: <?php echo $row['event_start_date']; ?></div>
                                    </div>
                                </div>
                            <?php endif; ?>
                        <?php
