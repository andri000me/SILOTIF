			...
			<?php echo form_open_multipart(base_url().'admin/event/edit/'.$event['event_id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Registration Start Date <span>*</span></label>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Registration End Date <span>*</span></label>
							<div class="col-sm-2">
